...
public final class RecaptchaWebProvider implements CaptchaProvider {
    ...
    @Builder
    public RecaptchaWebProvider(@NonNull String domain,
        ...
        this.httpClient = httpClient != null ? httpClient : HttpClient.newBuilder()
                ...
                .build();
        this.secretKey = secretKey != null ? secretKey : secretStore.get("RECAPTCHA_SECRET_KEY")
                .orElseThrow(() -> new IllegalArgumentException("recaptcha site key required"));

        this.domain = domain;
        this.mapper = mapper != null ? mapper : new ObjectMapper();
        this.verifyUrl = verifyUrl != null ? verifyUrl : "https://www.google.com/recaptcha/api/siteverify";
    }
    ...
    public boolean verify(@NonNull BotRequest<?> request, @NonNull String answer) {
        String form = "secret=" + URLEncoder.encode(secretKey, StandardCharsets.UTF_8)
                + "&response=" + URLEncoder.encode(answer, StandardCharsets.UTF_8);
