...
public interface BotArgumentConverter<T, D> {
    ...
    @NonNull
    D convert(@NonNull String raw, @NonNull Context<T> ctx) throws BotApiException;
    ...
    final class RequestConverter implements BotArgumentConverter<BotRequest<Object>, BotRequest<Object>> {

        @Override
        public @NonNull BotRequest<Object> convert(@NonNull String raw,
                                                   @NonNull Context<BotRequest<Object>> ctx) throws BotApiException {
            return ctx.data();
        }
