...
public class BotSessionImplTest {
    ...
    private static class DummyBot implements LongPollingBot {
        ...
        DummyBot(DefaultBotOptions opt) { this.opt = opt; }
        @Override public void onUpdateReceived(Update update) {}
        @Override public void onUpdatesReceived(List<Update> updates) {}
        @Override public BotOptions getOptions() { return opt; }
        @Override public void clearWebhook() {}
        @Override public void onClosing() {}
        @Override public String getBotUsername() { return ""; }
    ...
    private static class NoopExecutor extends AbstractExecutorService {
        ...
        @Override public void execute(Runnable command) { /* do nothing */ }
    }
}
