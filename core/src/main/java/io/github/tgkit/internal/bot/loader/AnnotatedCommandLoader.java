...
import static io.github.tgkit.internal.reflection.ReflectionUtils.newInstance;
...
import io.github.tgkit.internal.annotation.matching.CustomMatcher;
...
import io.github.tgkit.internal.args.BotArgumentConverter;
import io.github.tgkit.internal.args.Converters;
...
import io.github.tgkit.internal.event.impl.RegisterCommandBotEvent;
import io.github.tgkit.internal.exception.BotApiException;
import io.github.tgkit.internal.loader.BotCommandFactory;
import io.github.tgkit.internal.matching.AlwaysMatch;
...
public final class AnnotatedCommandLoader {
  ...
  private static @NonNull CommandMatch<? extends BotApiObject> extractMatcher(
    ...
    if (method.isAnnotationPresent(MessageContainsMatch.class)) {
      ...
      return new io.github.tgkit.internal.matching.MessageContainsMatch(
      ...
      return new io.github.tgkit.internal.matching.MessageRegexMatch(
      ...
      return new io.github.tgkit.internal.matching.MessageTextMatch(
      ...
      return new io.github.tgkit.internal.matching.UserRoleMatch<>(provider, Set.of(ur.roles()));
    } else {
