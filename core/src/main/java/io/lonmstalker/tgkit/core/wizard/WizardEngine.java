...
/**
 * Диспетчер пошаговых сценариев (wizard).
 * Поддерживает мультисессии, pause/resume, timeout/reminders и ветвления.
 */
public interface WizardEngine {
     ...
     */
    @NonNull
    String start(@NonNull String wizardId,
                 @NonNull BotRequest<?> request);

    /**
     * Продолжает работу существующей или создаёт новую сессию,
     * исходя из данных в request (payload содержит sessionId).
     *
