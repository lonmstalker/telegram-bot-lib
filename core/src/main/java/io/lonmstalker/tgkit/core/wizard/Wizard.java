 ...
 * <p>
 * Каждый конкретный сценарий наследует этот класс, объявляет шаги через {@link #stepId(String)}
...
public abstract class Wizard<M> {
     ...
     */
    protected Wizard(@NonNull String id,
                     @NonNull Supplier<@NonNull M> modelFactory) {
        this.id = id;
