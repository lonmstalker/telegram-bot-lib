...
public final class Converters {
    ...
    private static final Map<Class<?>, BotArgumentConverter<?, ?>> BY_CLASS = new ConcurrentHashMap<>();
    ...
    public static <T> void register(
            ...
            @NonNull BotArgumentConverter<?, ?> converter) {
    ...
    public static <T> BotArgumentConverter<Object, T> getByClass(
        ...
        return (BotArgumentConverter<Object, T>) BY_CLASS
                .computeIfAbsent(cls, r -> (BotArgumentConverter<Object, T>) ReflectionUtils.newInstance(r));
    }
}
