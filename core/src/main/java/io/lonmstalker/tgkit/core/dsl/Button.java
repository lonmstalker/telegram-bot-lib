...
public interface Button {
    ...
    static @NonNull Button urlKey(@NonNull String key,
                                  @NonNull String url,
                                  @NonNull Object... args) {
    ...
    static @NonNull Button cbKey(@NonNull String key,
                                 @NonNull String data,
                                 @NonNull Object... args) {
        return loc -> InlineKeyboardButton.builder()
                .text(loc != null ? loc.get(key, args) : key)
