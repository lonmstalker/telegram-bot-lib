...
public final class RequestValidators {
     ...
     * @return {@link Validator} на {@link BotRequest}, бросающий {@link ValidationException}
     * с ключом "error.invalidRequestType" при несовпадении
     */
    public static Validator<BotRequest<?>> requestType(BotRequestType expected) {
        return req -> {
            if (req.requestType() != expected) {
                throw new ValidationException(new MessageKey(
     ...
     *
     * @return {@link Validator} на {@link BotRequest}, бросающий {@link ValidationException}
     * с ключом "error.missingUserId" при отсутствии userId
     */
     ...
     *
     * @return {@link Validator} на {@link BotRequest}, бросающий {@link ValidationException}
     * с ключом "error.missingChatId" при отсутствии chatId
     */
