package io.lonmstalker.core.processor;
...
public class BotHandlerProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        TypeMirror botResponse = processingEnv.getElementUtils()
                .getTypeElement(BotResponse.class.getName()).asType();
        TypeMirror botRequest = processingEnv.getElementUtils()
                .getTypeElement(BotRequest.class.getName()).asType();
